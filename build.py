...
{chr(10).join(case_card(c) for c in CASES)}
      ...
      <div class="sec-head reveal" style="margin-top:96px">
        ...
        <span class="mono">Shorter reads</span>
      </div>
      <div class="more-grid reveal">
        <div class="more-card"><span class="mono">Insurance &middot; AI</span><h4>Insurance AI platform</h4><p>Research, workshops, and UI for an AI underwriting platform.</p></div>
        <div class="more-card"><span class="mono">Aviation &middot; IoT</span><h4>Smart hangar app</h4><p>Research, design system, and UI for connected hangar hardware.</p></div>
        <div class="more-card"><span class="mono">HR &middot; Payments</span><h4>Global payment platform</h4><p>UX, UI, and design system for a global HR and payments web app.</p></div>
      </div>
    </div>
  </section>'''
